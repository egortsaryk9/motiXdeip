...
export const APP_CMD = createEnum({
  ...
  CREATE_NFT_COLLECTION: 3,
  UPDATE_NFT_COLLECTION: 4,
...
export const APP_EVENT = createEnum({
  NFT_COLLECTION_CREATED: 1,
  NFT_COLLECTION_UPDATED: 2,
  ...
  NFT_ITEM_CREATED: 120,
  NFT_ITEM_UPDATED: 121,
  NFT_ITEM_DELETED: 122,
  NFT_ITEM_MODERATED: 126,
